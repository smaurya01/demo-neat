...
def make_nv12_input_options(width: int, height: int, fps: int):
    ...
    # Replaces `use_simaai_pool` (deprecated in 0.4.0). Ev74 = EV74-visible memory, which the
    # reference apps use for raw Image ingress; measured +15% here (host-push-bound with headroom).
