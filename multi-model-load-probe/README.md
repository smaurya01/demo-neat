...
```bash
mkdir -p /workspace/demo-neat/multi-model-load-probe/assets/models
cd /workspace/demo-neat/multi-model-load-probe/assets/models
...
```text
/workspace/demo-neat/multi-model-load-probe/assets/models/yolo_v8n_mpk.tar.gz
/workspace/demo-neat/multi-model-load-probe/assets/models/yolo_v8n_seg_mpk.tar.gz
/workspace/demo-neat/multi-model-load-probe/assets/models/yolo26n-det-bf16-mla_tess-b1.tar.gz
/workspace/demo-neat/multi-model-load-probe/assets/models/open_pose_mpk.tar.gz
```
...
udp_port_base=5201
models_dir=/workspace/demo-neat/multi-model-load-probe/assets/models
```
...
```bash
cmake -S /workspace/demo-neat/multi-model-load-probe \
  -B /workspace/demo-neat/multi-model-load-probe/build \
...
cmake --build /workspace/demo-neat/multi-model-load-probe/build --parallel
```
...
```bash
dk /workspace/demo-neat/multi-model-load-probe/build/multi_model_load_probe \
  --config /workspace/demo-neat/multi-model-load-probe/config/default.conf
```
